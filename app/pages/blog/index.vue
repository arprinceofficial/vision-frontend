                ...
                <div class="max-w-5xl">
                    ...
                    <div class="mt-9 grid max-w-3xl grid-cols-1 gap-3 sm:grid-cols-3">
                        ...
                        <div class="border-l border-tccGold/50 pl-4">
                            ...
                            <strong class="mt-1 block text-2xl font-black text-tccGold">{{ categories.length - 1
                                }}</strong>
                        </div>
                        <div class="border-l border-tccGold/50 pl-4">
                            <span
        ...
        <section id="journal-grid" class="bg-tccDeepBlack py-20 text-white">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
                    <NuxtLink v-for="post in filteredPosts" :id="post.slug" :key="post.slug" :to="`/blog/${post.slug}`"
                ...
                <div class="mt-12 flex justify-center">
                    <div class="inline-flex items-center gap-1 rounded-full border border-white/10 bg-white/5 p-1">
                        <button type="button"
                            class="flex h-9 w-9 items-center justify-center rounded-full text-white/40 transition-colors hover:text-tccGold"
                            aria-label="Previous page">
                            <i class="pi pi-chevron-left text-xs" aria-hidden="true" />
                        </button>
                        <button type="button"
                            class="h-9 min-w-9 rounded-full bg-tccGold px-3 font-poppins text-sm font-bold text-tccDarkNavy">1</button>
                        <button type="button"
                            class="h-9 min-w-9 rounded-full px-3 font-poppins text-sm font-bold text-white/70 transition-colors hover:bg-white/10 hover:text-tccGold">2</button>
                        <button type="button"
                            class="h-9 min-w-9 rounded-full px-3 font-poppins text-sm font-bold text-white/70 transition-colors hover:bg-white/10 hover:text-tccGold">3</button>
                        <button type="button"
                            class="flex h-9 w-9 items-center justify-center rounded-full text-white/70 transition-colors hover:text-tccGold"
