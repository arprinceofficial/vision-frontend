...
const updateHandler = async () => {
    ...
    try {
        ...
        const getData = await $fetchAdmin(`v1/admin/icon-categories/${props.item.id}`, {
            method: 'PUT',
            body: formData.value,
        });
    ...
    <Dialog v-model:visible="visible" modal :closable="false" :style="{ width: '30rem' }"
        ...
        <div class="grid grid-cols-1 gap-4">
            <div class="flex items-center gap-4">
                ...
                <div class="flex-auto">
                    <LazyInputText v-model="formData.title" class="w-full" placeholder="i.e. Hero Icons"
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex-auto">
                    <LazyInputText v-model="formData.slug" class="w-full" placeholder="i.e. hero-icons"
