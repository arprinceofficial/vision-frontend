...
const loadData = async () => {
    ...
    permissions.value = {};
    try {
        const getData = await $fetchAdmin(`v1/admin/tutorials/all`, {
            method: 'POST',
            body: {
                paginate: true,
...
const loadTutorialCategories = async () => {
    isLoading.value = true;
    try {
        const getData = await $fetchAdmin(`v1/admin/tutorial-categories`, {
            method: 'GET',
        });
...
const deleteHandler = async () => {
    ...
    try {
        const getData = await $fetchAdmin(`v1/admin/tutorials/${deleteId.value}`, {
            method: 'DELETE',
        });
...
const restoreHandler = async (id) => {
    response_modal.value = {};
    try {
        const getData = await $fetchAdmin(`v1/admin/tutorial-categories/restore/${id}`, {
            method: 'POST',
        });
        if (getData.status == true) {
            response_modal.value = getData;
