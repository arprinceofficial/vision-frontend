        ...
        <div
          ...
          <div class="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            <div>
              ...
              <p class="mt-2 max-w-2xl text-[13px] leading-relaxed text-white/60">
                Review pending transfers, funded allocations, references, and the next action for each syndicate
                purchase.
              </p>
            </div>
          ...
          <div class="mt-5 grid gap-3 sm:grid-cols-3">
            <div class="rounded-xl border border-white/10 bg-white/[0.05] p-3.5">
              ...
              <strong class="mt-1.5 block font-poppins text-xl font-black text-white">{{ transactionSummary.total
                }}</strong>
            </div>
            <div class="rounded-xl border border-orange-400/25 bg-orange-400/10 p-3.5">
              ...
              <strong class="mt-1.5 block font-poppins text-xl font-black text-orange-100">{{ transactionSummary.pending
                }}</strong>
            </div>
            <div class="rounded-xl border border-tccGold/30 bg-tccGold/10 p-3.5">
              ...
              <strong class="mt-1.5 block font-poppins text-xl font-black text-tccGold">{{ transactionSummary.funded
                }}</strong>
            </div>
          </div>
        </div>
