            ...
            <aside class="space-y-6">
                <section class="restomod-panel rounded-[1.5rem] p-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="rounded-full bg-tccGold px-2.5 py-1 text-[10px] font-bold text-tccDarkNavy">{{
                ...
                <section class="restomod-panel rounded-[1.5rem] p-6">
                    ...
                    <div class="mt-5 divide-y divide-white/10">
                        <a v-for="document in documents" :key="document.title" href="/profile"
