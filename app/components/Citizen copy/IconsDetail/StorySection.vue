...
const fallbackStoryHero = '/assets/images/citizen/icons/detail/story-hero.jpg'
const fallbackStoryCardOne = '/assets/images/citizen/icons/detail/story-card-01.jpg'
const fallbackStoryCardTwo = '/assets/images/citizen/icons/detail/story-card-02.jpg'
            ...
            <div class="grid gap-10">
                ...
                <div class="rounded-[16px] border-2 border-[#977b13] p-8">
                    <div class="grid grid-cols-3 gap-8">
                        <div class="overflow-hidden rounded-[16px] border border-[#977b13] bg-black aspect-[420/592]">
                            <img :src="storyCardOne" alt="Story card" class="h-full w-full object-cover" />
                        </div>

                        <div class="overflow-hidden rounded-[16px] border border-[#977b13] bg-black aspect-[420/596]">
        ...
        <div class="px-4 pb-14 xl:hidden sm:px-6 sm:pb-20">
            ...
            <div class="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-5 xl:grid-cols-3">
                ...
                <article
                    ...
                    <NuxtLink :to="storyButtonLink || undefined"
                        class="mx-auto mt-6 flex items-center justify-center min-h-[40px] w-full max-w-[325px] rounded-full bg-[linear-gradient(158.19deg,#977b13_28.673%,#d4af37_71.327%)] px-4 py-2 text-center text-[clamp(0.88rem,2.3vw,1rem)] leading-[1.25] text-black shadow-[0_4px_24px_rgba(0,0,0,0.25)]">
                        {{ storyButtonText }}
                    </NuxtLink>
                </article>
            </div>
