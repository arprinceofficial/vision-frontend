...
<template>
    <div class="space-y-6">
        ...
        <div class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_20rem]">
            <div class="space-y-6">
                <section class="rounded-xl border border-tccGold/35 bg-tccGold/10 p-5 text-center shadow-[0_18px_70px_rgba(0,0,0,0.22)] sm:p-6">
                ...
                <section class="rounded-xl border border-white/10 bg-white/[0.04] p-5">
                    ...
                    <div class="mt-4 grid gap-3 sm:grid-cols-2">
                        <div class="rounded-lg border border-white/10 bg-tccDeepBlack/70 px-4 py-3">
                            <span class="text-[11px] font-black uppercase tracking-[0.14em] text-white/45">Vehicle:</span>
                            <strong class="mt-1 block text-sm text-white">{{ agreement.vehicle }}</strong>
                        </div>
                        <div class="rounded-lg border border-white/10 bg-tccDeepBlack/70 px-4 py-3">
                            <span class="text-[11px] font-black uppercase tracking-[0.14em] text-white/45">Number of Allocations:</span>
                            <strong class="mt-1 block text-sm text-white">{{ agreement.allocations }}</strong>
                        </div>
                        <div class="rounded-lg border border-white/10 bg-tccDeepBlack/70 px-4 py-3">
                            <span class="text-[11px] font-black uppercase tracking-[0.14em] text-white/45">Signed Date:</span>
                            <strong class="mt-1 block text-sm text-white">{{ signedDate }}</strong>
                        </div>
                        <div class="rounded-lg border border-white/10 bg-tccDeepBlack/70 px-4 py-3">
                            <span class="text-[11px] font-black uppercase tracking-[0.14em] text-white/45">Reference:</span>
                            ...
                            <div class="pdf-preview-page mx-auto min-h-[28rem] max-w-2xl p-6 sm:p-10">
                                <div class="border-t border-[#b8c0cc] pt-7">
                                    ...
                                    <div class="pdf-preview-signature mt-10 rounded border border-dashed p-4">
                                        <span class="pdf-preview-kicker text-xs font-semibold uppercase tracking-[0.16em]">
