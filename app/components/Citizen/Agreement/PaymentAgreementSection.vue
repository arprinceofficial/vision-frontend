        ...
        <div class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_24rem]">
            <div class="space-y-5">
                <section class="rounded-xl border border-tccGold/20 bg-[#11100d] p-5 shadow-[0_18px_70px_rgba(0,0,0,0.24)]">
                    ...
                    <div class="mt-5 grid gap-4 md:grid-cols-[16rem_minmax(0,1fr)]">
                        <div class="relative min-h-52 overflow-hidden rounded-lg border border-white/10 bg-tccDeepBlack/70 md:h-full">
                            <img
