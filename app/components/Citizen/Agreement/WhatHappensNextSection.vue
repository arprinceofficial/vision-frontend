...
<template>
    <div class="rounded-xl border border-tccGold/20 bg-[#0b0a08] p-4 shadow-[0_24px_90px_rgba(0,0,0,0.35)] sm:p-6 lg:p-7">
        <div class="rounded-lg border border-white/10 bg-[#11100d] p-5 text-white sm:p-7 lg:p-8">
            <div class="text-center">
                <span class="mx-auto grid h-14 w-14 place-items-center rounded-full bg-tccDeepBlack text-tccGold shadow-lg shadow-tccGold/10 ring-1 ring-tccGold/35">
            ...
            <div class="mt-7 grid gap-4 lg:grid-cols-3">
                ...
                >
                    <span class="mx-auto grid h-12 w-12 place-items-center rounded-full bg-tccDeepBlack text-tccGold ring-1 ring-tccGold/30">
            ...
            <div class="mt-7 rounded-lg border border-white/10 bg-white/[0.035] p-4 sm:p-5">
                ...
                <div class="mt-4 space-y-3">
                    <div class="flex gap-3 rounded-md border-l-4 border-tccGold bg-tccDeepBlack/80 p-4 text-sm leading-relaxed text-white/70">
                        ...
                        <p>
                            ...
                            <strong class="text-white">will not</strong> leave a footprint on any credit report and is to clarify identity only.
                        </p>
                    </div>
                    <div class="flex gap-3 rounded-md border-l-4 border-tccGold bg-tccDeepBlack/80 p-4 text-sm leading-relaxed text-white/70">
                        <i class="pi pi-wallet mt-1 text-tccGold" aria-hidden="true" />
                        <p>
                            Please make sure funds are transferred from a bank account with the same name and address you have used to register with us.
                        </p>
                    </div>
                </div>
            </div>

            <div class="mt-6 flex flex-col gap-4 rounded-lg border border-tccGold/40 bg-tccGold/10 p-4 sm:flex-row sm:items-center">
                <span class="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-tccDeepBlack text-tccGold">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-white/70">
                        ...
                        <a :href="`mailto:${supportEmail}`" class="font-black text-tccGold underline decoration-tccGold/70 underline-offset-4">
                            {{ supportEmail }}
                        </a>
